<template>
    ...
    <el-container style="height: 500px; border: 1px solid #eee">
        <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
            <el-menu>
                <el-submenu index="1">
                    <template slot="title"><i class="el-icon-message"></i>商品页面</template>
                </el-submenu>
                <el-submenu index="2">
                    ...
                    <el-menu-item-group>
                        ...
                        <el-menu-item index="2-2" @click="view_my_bought">待收货</el-menu-item>
                ...
                <el-submenu index="3">
                    ...
                    <el-menu-item-group>
                        <el-menu-item index="3-1" @click="view_my_history_bought">购买记录</el-menu-item>
                    </el-menu-item-group>
                </el-submenu>
            </el-menu>
        </el-aside>
        ...
        <el-dialog title="评价历史" :visible.sync="dialogHistoryBoughtTableVisible">
            <el-table :data="user_eval_list">
                ...
                <el-table-column property="c_name" label="用户姓名"></el-table-column>
